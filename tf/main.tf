...
variable "appname" {default = "WebsocketChatExample" }
variable "host_port" { default = 8000 }
variable "docker_port" { default = 8000 }
variable "lb_port" { default = 80 }
variable "aws_region" { default = "us-east-1" }
variable "key_name" {}
variable "dockerimg" { default = "websocket_chat"}
